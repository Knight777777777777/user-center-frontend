...
const StepDescriptions: React.FC<{
  ...
  return (
    <Descriptions column={1} bordered={bordered}>
      <Descriptions.Item label="付款账号"> {payAccount}</Descriptions.Item>
      <Descriptions.Item label="收款账号"> {receiverAccount}</Descriptions.Item>
      ...
      <Card bordered={false}>
        ...
        >
          ...
          >
            ...
            <ProForm.Group title="收款账号" size={8}>
              <ProFormSelect
                name="receiverMode"
                rules={[{ required: true, message: '请选择付款账号' }]}
                valueEnum={{
          ...
          <StepsForm.StepForm title="确认转账信息">
            <div className={styles.result}>
              <Alert
                closable
                showIcon
                message="确认转账后，资金将直接打入对方账号，无法退回。"
